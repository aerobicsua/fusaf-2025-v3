...
export default function MembershipPage() {
  ...
  const handleRoleSelection = (role: string) => {
    // Перенаправляємо прямо на форми реєстрації без проміжних сторінок
    const rolePath = role === 'club_owner' ? 'club-owner' : role === 'coach_judge' ? 'coach-judge' : role;
    router.push(`/membership/${rolePath}/registration`);
  };
